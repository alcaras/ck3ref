...
MAPPED = {
    ...
    "character_interactions": "build_interactions.py",
    "character_interaction_categories": "build_interactions.py",
    "secret_types": "build_interactions.py",
    "hook_types": "build_interactions.py",
    "factions": "build_realm2.py",
    "succession_election": "build_realm2.py",
    "succession_appointment": "build_realm2.py",
    "vassal_stances": "build_realm2.py",
    "confederation_types": "build_realm2.py",
    "tax_slots": "build_realm2.py",
    "lease_contracts": "build_realm2.py",
    "court_types": "build_court2.py",
    "court_amenities": "build_court2.py",
    "inspirations": "build_court2.py",
    "game_rules": "build_court2.py",
...
SKIP = {
    # phase 2
        "accolade_icons", "dynasty_houses", "dynasties",
    "dynasty_house_mottos", "dynasty_house_motto_inserts", "story_cycles", "bookmarks", "flavorization",
    "raids",
